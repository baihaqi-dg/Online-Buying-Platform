...
function getCats(){
	...
	echo "<li><a href='menuUtama.php?cat=$cat_id'>$cat_title</a></li>";
...
function getBrands(){
	...
	echo "<li><a href='menuUtama.php?brand=$brand_id'>$brand_title</a></li>";
	...
	while($row_pro=mysqli_fetch_array($run_pro)){
		...
		echo "
				<div id='single_product'>
					...
					<p><b> Price: RM $pro_price </b></p></br>

          <p><b> Company Name <br></b> $pro_brand</p></br>

					<a href='details.php?pro_id=$pro_id' style='float:left;'>Details</a>

					<a href='menuUtama.php?add_cart=$pro_id'><button style='float:right'>Add to Cart</button></a>
	...
	while($row_cat_pro=mysqli_fetch_array($run_cat_pro)){
		...
		echo "
				<div id='single_product'>
					...
					<a href='menuUtama.php?pro_id=$pro_id'><button style='float:right'>Add to Cart</button></a>
